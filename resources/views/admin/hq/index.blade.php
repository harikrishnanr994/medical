    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">HQ Admins</a></li>
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h2><a href="{{ route('hq.create') }}" class="btn btn-warning btn-sm">Add New HQ Admin </a> </h2>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                @if(count($users))
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            ?>
                                            <td>
                                                <a href="{{ route('hq.edit',$user->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>
                                                {!! Form::open(['method' => 'DELETE','onsubmit' => "return confirm('".trans("Are you sure want to delete")."');", 'route' => ['hq.destroy', $user->id] ]) !!}
