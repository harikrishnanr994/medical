                                ...
                                <div class="box-header with-border">
                                    ...
                                    @if(isset($msg) && $msg == "failed")
                                        <div class="alert alert-danger alert-dismissable col-lg-4" style="text-align: center;">
                                            ...
                                            <i class="fa fa-exclamation-circle"></i> Failed . Try Again
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-md-6 col-lg-10">
                                                <table class="table table-responsive table-borderless table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <a href="{{ route('admin.slider.web.view', $slider->id) }}" class="btn btn-sm  btn-info">View</a>
                                        ...
                                        <div class="row listSec" style="display: none;">
                                            <div class="col-12">
                                                <div class="box">
                                                    ...
                                                    <div class="box-body">
                                                        <form role="form" id="listForm" method="post" action="{{ route('admin.slider.web.save') }}" enctype="multipart/form-data" >
                                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-4">
                                                                    ...
                                                                    <div class="input-group date">
                                                                        ...
                                                                        <input type="text" class="form-control pull-right" id="datepicker" name="start_date1" style="text-align: center;" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-4">
                                                                    ...
                                                                    <div class="input-group date">
                                                                        ...
                                                                        <input type="text" class="form-control pull-right" id="datepicker2" name="end_date1" style="text-align: center;" required >
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="row detailSec" style="display: none;">
                                            <div class="col-12">
                                                <div class="box">
                                                    ...
                                                    <div class="box-body">
                                                        <form  id="detailForm" method="post" action="{{ route('admin.slider.web.save') }}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="form-group">
                                                               ...
                                                               <!-- <i type="text" class="form-control" placeholder="Slug" name="slug" onkeypress="getProduct()" required>-->
                                                            </div>
