                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="pull-right">
                                                <button  class="btn btn-sm bg-primary listEdit" >Edit</button>
                                            </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="pull-right">
                                            <button  class="btn btn-sm bg-primary detailEdit">Edit</button>
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="box">
                            ...
                            @foreach($datas as $data1)
                                <div class="box-body">
                                    <form role="form" id="listForm" method="post" action="{{ route('admin.slider.mobile.update',$data1->id) }}" enctype="multipart/form-data" >
                                        {{ csrf_field() }}
                                                ...
                                                <div class="box">
                                                    <div class="box-body">
                                                        <div class="previewImg" id="previewImg">
                                                            <img  class="imageThumb" src="{{asset('images/'.$data1->image )}}"  width="200" height="150">
                                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-4">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control pull-right" id="datepicker" name="start_date1" value="{{ $data1->start_date }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" col-4">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control pull-right" id="datepicker2" name="end_date1" value="{{ $data1->expiry_date }}" required>
                                                </div>
                                            </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                @foreach($datas as $data2)
                                    <form  id="detailForm" method="post" action="{{ route('admin.slider.mobile.update',$data2->id) }}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                                ...
                                                <div class="box">
                                                    <div class="box-body">
                                                        <div class="previewImg" id="previewImg1">
                                                            <img  class="imageThumb1" src="{{asset('images/'.$data2->image )}}"  width="200" height="150">
                                                        </div>
                                                        <div class="form-group"  style="text-align: center;">
                                                            <div class="btn bg-pink btn-file">
